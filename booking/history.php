                            ...
                            <table id="myTable" class="display" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>1</td>
                                        <td><a  href="img/Booking_doc/BSE23110114.pdf" target="_blank">ไฟล์ใบเสนอราคา</a></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>$170,750</td>
                                        <td>$320,800</td>
                                        <td><div class="alert alert-danger" role="alert" style="padding: 0px;">
                                               <center>ยกเลิก</center> 
                                            </div></td>
                                        <td>1</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>$86,000</td>
                                        <td>$320,800</td>
                                        <td><div class="alert alert-success" role="alert" style="padding: 0px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>$433,060</td>
                                        <td>$320,800</td>
                                        <td><div class="alert alert-warning" role="alert" style="padding: 0px;">
                                               <center>รอผล</center> 
                                            </div></td>
                                        <td>1</td>
                                        <td><a href="#">ไฟล์ใบเสนอราคา</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>$162,700</td>
                                        <td>$320,800</td>
                                        <td><div class="alert alert-info" role="alert" style="padding: 0px;">
                                               <center>ขนส่ง</center> 
                                            </div></td>
                                        <td>1</td>
                                        <td><a href="#">ไฟล์ใบเสนอราคา</a></td>
